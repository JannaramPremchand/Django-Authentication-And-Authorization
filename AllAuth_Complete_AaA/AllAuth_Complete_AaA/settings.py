"""
Django settings for AllAuth_Complete_AaA project.
...
SECRET_KEY = 'django-insecure-l24ddbozgvejjiv1o*ze5myo%)#b0_u(kfj-*4$x+^=fko@__7'
...
ROOT_URLCONF = 'AllAuth_Complete_AaA.urls'
...
WSGI_APPLICATION = 'AllAuth_Complete_AaA.wsgi.application'
