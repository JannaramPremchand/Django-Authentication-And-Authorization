"""
Django settings for AllAuth_SignIn_SignUp project.
...
SECRET_KEY = 'django-insecure-rx%l$bdpl@1h@n%=hz4qobl1y6pz0@mb9@d&^cp&-^ju#r1v*k'
...
ROOT_URLCONF = 'AllAuth_SignIn_SignUp.urls'
...
WSGI_APPLICATION = 'AllAuth_SignIn_SignUp.wsgi.application'
...
ACCOUNT_SIGNUP_PASSWORD_ENTER_TWICE = os.getenv('ACCOUNT_SIGNUP_PASSWORD_ENTER_TWICE', 'True') == 'True'
...
EMAIL_BACKEND = os.getenv('EMAIL_BACKEND_DURING_DEV', os.getenv('EMAIL_BACKEND'))
