"""
Django settings for AllAuth_User_Models project.
...
SECRET_KEY = 'django-insecure-=1q&+fkdfys_66kmltx08sjokrjcys9wi10-%#kp-@d#@s@rdz'
...
ROOT_URLCONF = 'AllAuth_User_Models.urls'
...
WSGI_APPLICATION = 'AllAuth_User_Models.wsgi.application'
