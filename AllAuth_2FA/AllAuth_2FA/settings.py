"""
Django settings for AllAuth_2FA project.
...
SECRET_KEY = 'django-insecure-zt(=p$(!_opor$4v34vvis^vl12+be776pw8zr^bi-l%+l#g%#'
...
WSGI_APPLICATION = 'AllAuth_2FA.wsgi.application'
