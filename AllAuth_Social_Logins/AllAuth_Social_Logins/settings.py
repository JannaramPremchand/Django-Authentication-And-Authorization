"""
Django settings for AllAuth_Social_Logins project.
...
SECRET_KEY = 'django-insecure-@xvwc-%2*6g2+065ft%6q07s-$m&qr6v7gh4i@yh-^4wj1f)z#'
...
ROOT_URLCONF = 'AllAuth_Social_Logins.urls'
...
WSGI_APPLICATION = 'AllAuth_Social_Logins.wsgi.application'
